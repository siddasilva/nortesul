...
?>
	...
	<div class="page-content-wrapper">
		...
		<small><span class="badge badge-roundless badge-success">Versão Alpha do Despacho Operacional</span></small>
            ...
            <hr>
			<h1 class="page-title">Voos Online</small></h1>
			<!-- END PAGE HEADER-->
...
<div class="mapcenter" align="center">
	<div id="acarsmap" style="width:90%; height: 768px"></div>
</div>
<?php
/* See below for details and columns you can use in this table */
?>
<table class="table table-striped table-hover" width='10%' style="font-size:14px; margin: 20px ;">
<thead>
                <tr style="vertical-align: middle;">
                    <td width="23%" style="background-color: #2A0088; text-align: center; vertical-align: middle;"><span style="color: #FFF;">Tripulante</span></td>
                    <td width="08%" style="background-color: #2A0088; text-align: center; vertical-align: middle;"><span style="color: #FFF;">Voo</span></td>
                    <td width="10%" style="background-color: #2A0088; text-align: center; vertical-align: middle;"><span style="color: #FFF;">DEP - ARR</span></td>
                    <td width="07%" style="background-color: #2A0088; text-align: center; vertical-align: middle;"><span style="color: #FFF;">Altitude</span></td>
                    <td width="08%" style="background-color: #2A0088; text-align: center; vertical-align: middle;"><span style="color: #FFF;">Velocidade</span></td>
                    <td width="14%" style="background-color: #2A0088; text-align: center; vertical-align: middle;"><span style="color: #FFF;">Dist. Restante / ETD</span></td>
                    <td width="14%" style="background-color: #2A0088; text-align: center; vertical-align: middle;"><span style="color: #FFF;">Progresso</span></td>
                </tr>
            </thead>
