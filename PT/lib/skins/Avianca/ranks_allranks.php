...
<html lang="en">
  <head>
    ...
    <title>
      Plano de Carreira | Avianca Virtual
    </title>
    ...
    <header class="head-section">
      <div class="navbar navbar-default navbar-static-top container">
          <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index.html"><img src="<?php echo SITE_URL?>/lib/skins/Avianca/img/logo.png" alt="logo" style="width:192px; height:auto;"></a>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8 col-sm-8">
            <ol class="pull-right">
              <h1 class="pequeno">Unidos Somos Avianca</h1>
            </ol>
          </div>
        </div>
      </div>
    ...
    <footer class="footer-small">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                  <div class="copyright">
                    <p>&copy; Copyright <?php echo date("Y");?> Aviancav.  Todos os direitos reservados.</p>
                  </div>
                </div>
            </div>
        </div>
