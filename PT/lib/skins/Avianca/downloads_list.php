...
<html>
  <head>
    ...
    <title>Despacho Operacional | Downloads</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="<?php echo SITE_URL?>/index.php/downloads"><i class="fa fa-download"></i> <span>Downloads</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
           <?php 
               if(!$allcategories)
                {
	             echo '<div class="alert alert-warning">Nenhum Download Encontrado</div>';
	             return;
                }
                ...
                {
             ?>
             <p><h3><?php echo $category->name?></h3></p>
             <ul>
...
<?php	
	...
	if(!$alldownloads)
	{
		echo '<div class="alert alert-danger">Nenhum Download Encontrado</div>';
		$alldownloads = array();
	}
	else{
...
?>
	<div class="row">
      <div class="col-xs-18 col-sm-6 col-md-3">
        <div class = "thumbnail">
         <a href="<?php echo url('/downloads/dl/'.$download->id);?>"><img src = "<?php echo $download->image?>" alt ="<?php echo $download->name?>"></a>
           <div class = "caption">
             <a href="<?php echo url('/downloads/dl/'.$download->id);?>"><h5><?php echo $download->name?></h5></a>
             <p><?php echo $download->description?></p>
         
             <p>
               <a href = "<?php echo url('/downloads/dl/'.$download->id);?>" class = "btn btn-primary btn-flat centered" role = "button">
                  Baixar
               </a>
            </p>
