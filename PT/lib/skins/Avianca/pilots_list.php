  ...
  <body>
    ...
    <div class="container" id="tourpackages-carousel">
      ...
      <table id="tabledlist" class="table table-striped">
            <thead>
              <tr>
	           <th class="quadro roxo" width="21%">Matricula</th>
	           <th class="quadro roxo" width="33%">Nome</th>
	           <th class="quadro roxo" width="18%">País</th>
	           <th class="quadro roxo" width="14%">Horas</th>
               <th class="quadro roxo" width="14%">Ranking</th>
              </tr>
            </thead>
            <tbody>
              <?php 
