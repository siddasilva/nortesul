...
<html>
  <head>
    ...
    <title>Despacho Operacional | Reservar Voo</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-user"></i> <span><?php echo $pilot->firstname . ' ' . $pilot->lastname; ?></span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="<?php echo SITE_URL?>/index.php/profile/stats">Minhas Estatísticas</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#"><i class="fa fa-plane"></i> <span>Despacho de Voos</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="<?php echo url('/schedules/view'); ?>">Reservar Voo</a></li>
                <li><a href="<?php echo SITE_URL?>/index.php/pireps/mine">Logbook</a></li>
                <li><a href="<?php echo SITE_URL?>/index.php/pireps/routesmap">Mapa de todos os voos</a></li>
              </ul>
            </li>
            <li><a href="<?php echo SITE_URL?>/index.php/downloads"><i class="fa fa-download"></i> <span>Downloads</span></a></li>
            <li><a href="<?php echo SITE_URL?>/index.php/Mail"><i class=" fa fa-envelope"></i> <span>Intra Mail</span></a></li>
            <li><a href="<?php echo SITE_URL?>/index.php/events"><i class="fa fa-suitcase"></i> <span>Tours</span></a></li>
