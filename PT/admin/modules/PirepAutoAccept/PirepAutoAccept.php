...
class PirepAutoAccept extends CodonModule {
	...
	public function overview()
	{
		...
		$this->show('PirepAutoAccept/autopirep_criterialist');
		$this->set('settings', PirepAcData::get_settings());
		$this->show('PirepAutoAccept/autopirep_settings_mainform');
		$this->show('PirepAutoAccept/footer');
	...
	public function addcriteria()
	{
		...
		$this->show('PirepAutoAccept/autopirep_addcriteria');
	}
	...
	public function editcriteria()
	{
		...
		$this->show('PirepAutoAccept/autopirep_editcriteria');
